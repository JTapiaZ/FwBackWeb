...
exports.emailSend = (data) => {
    const oEmail = new Email({
        ...
        auth: {
            type: "OAuth2",
            user: "soportefwesleyana@gmail.com",
            pass: "SoporteFw2021#$",
            clientId: "919737992485-rnq7jmn55l6gad5l22c3fv3l7bb2atci.apps.googleusercontent.com",
            clientSecret: "h3vJj71pJsooPXlpTCmn109C",
            refreshToken: "1//04cbv-EfXUv0dCgYIARAAGAQSNwF-L9IruEN660XlxcV4rqvl5ZVyOyzaip0Z7nLc__vlO3HTDkfmXOD5oCNp6NK9wc-gChFBXhc",
          },
    })
    let email = 
    {
        from: "soportefwesleyana@gmail.com",
        to: "contratobello@gmail.com",
        subject: "¡Nuevo registro - Pagina Web!",
        html: `                                                                
                    ...
                    <table bgcolor="#ffffff" class="es-content-body" align="center" cellpadding="0" cellspacing="0" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px;background-color:transparent;width:600px"> 
                        ...
                        <table cellpadding="0" cellspacing="0" width="100%" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px"> 
                            ...
                            <table cellpadding="0" cellspacing="0" width="100%" role="presentation" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px"> 
                                <tr style="border-collapse:collapse"> 
                                <td align="center" style="padding:0;Margin:0;font-size:0px"><img class="adapt-img" src="https://noskev.stripocdn.email/content/guids/CABINET_a347109b578f19331e6e0d321f56588f/images/80931626321795256.jpg" alt style="display:block;border:0;outline:none;text-decoration:none;-ms-interpolation-mode:bicubic"></td> 
                                </tr> 
                                <tr style="border-collapse:collapse"> 
